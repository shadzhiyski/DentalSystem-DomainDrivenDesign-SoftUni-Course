        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CvcCode = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditCard_Client_HolderId",
                        column: x => x.HolderId,
                        principalTable: "Client",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patient_Client_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Client",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DentalWorker_DentalTeam_DentalTeamId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeRange_Start = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    TimeRange_End = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointment_DentalTeam_DentalTeamId",
                        column: x => x.DentalTeamId,
                        principalTable: "DentalTeam",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointment_DentalTeamId",
                table: "Appointment",
                column: "DentalTeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditCard_HolderId",
                table: "CreditCard",
                column: "HolderId");

            migrationBuilder.CreateIndex(
                name: "IX_DentalWorker_DentalTeamId",
                table: "DentalWorker",
                column: "DentalTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Patient_ClientId",
                table: "Patient",
                column: "ClientId",
                unique: true);
